...
#     echo '{ "name": "ostoslista", "version": "0.0.1", "dependencies": {} }' >> package.json
#
...
#
#     git checkout deploy
#     git add ./dist/build/ostoslista/ostoslista
#     git commit -m deploy
#
# * push to Heroku
#
...
web: ./dist/build/ostoslista/ostoslista production -p $PORT
